module.exports = {
	...
	/** NOTE:
	 * 
	 * This file has to much duplication of code. Also there is business logic here. Fix if time.
	 * 
	 * Also, if time, branch and put V2 functionality in a v2 function instead of a new service to show both ways.
	 */
	...
	async update(request, response) {
		...
		if(authenticated !== false) {
			...
			if(object.status && (object.status !== 'Completed' && object.status !== 'In Progress')) {
